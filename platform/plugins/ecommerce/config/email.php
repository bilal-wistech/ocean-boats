...
return [
    ...
    'templates' => [
        ...
        'custom_enquiry' => [
            'title' => 'Build a boat inquiry sent',
            'description' => 'Send to customer when a build a boat enquiry submitted',
            'subject' => 'Customize Boat Enquiry',
            'can_off' => true,
            'variables' => [
                'customer_name' => 'plugins/ecommerce::ecommerce.customer_name',
                'product_list' => 'plugins/ecommerce::ecommerce.product_list',
        ...
        'custom_enquiry_admin' => [
            'title' => 'Build a boat inquiry recieved',
            'description' => 'Send to Admin when a build a boat enquiry recieved',
            'subject' => 'Customize Boat Enquiry',
            'can_off' => true,
            'variables' => [
                'name' => 'plugins/ecommerce::ecommerce.customer_name',
                'product' => 'Product',
            ],
        ],
        'saved_boat_email' => [

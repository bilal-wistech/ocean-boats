        ...
        <url>
            ...
            <?php if(!empty($item['translations'])): ?>
                <?php $__currentLoopData = $item['translations']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $translation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <xhtml:link rel="alternate" hreflang="<?php echo e($translation['language']); ?>"
            ...
            <?php if(!empty($item['alternates'])): ?>
                <?php $__currentLoopData = $item['alternates']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alternate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <xhtml:link rel="alternate" media="<?php echo e($alternate['media']); ?>" href="<?php echo e($alternate['url']); ?>"/>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
                ...
                <?php $__currentLoopData = $item['videos']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <video:video>
                        ...
                        <?php if(isset($video['title'])): ?>
                            <video:title><![CDATA[<?php echo e($video['title']); ?>]]></video:title>
                        <?php endif; ?>
                        <?php if(isset($video['description'])): ?>
                            <video:description><![CDATA[<?php echo e($video['description']); ?>]]></video:description>
                        <?php endif; ?>
                        ...
                        <?php if(isset($video['requires_subscription'])): ?>
                            <video:requires_subscription><?php echo e($video['requires_subscription']); ?></video:requires_subscription>
                        <?php endif; ?>
                        <?php if(isset($video['live'])): ?>
                            <video:live><?php echo e($video['live']); ?></video:live>
                        <?php endif; ?>
                        <?php if(isset($video['player_loc'])): ?>
                            <video:player_loc allow_embed="<?php echo e($video['player_loc']['allow_embed']); ?>" autoplay="' .
                            $video['player_loc']['autoplay'] }}"><?php echo e($video['player_loc']['player_loc']); ?></video:player_loc>
                        <?php endif; ?>
                        <?php if(isset($video['restriction'])): ?>
                            <video:restriction
                                relationship="<?php echo e($video['restriction']['relationship']); ?>"><?php echo e($video['restriction']['restriction']); ?></video:restriction>
                        <?php endif; ?>
                        <?php if(isset($video['gallery_loc'])): ?>
                            <video:gallery_loc
                                title="<?php echo e($video['gallery_loc']['title']); ?>"><?php echo e($video['gallery_loc']['gallery_loc']); ?></video:gallery_loc>
                        <?php endif; ?>
                        <?php if(isset($video['price'])): ?>
                            <video:price
                                currency="<?php echo e($video['price']['currency']); ?>"><?php echo e($video['price']['price']); ?></video:price>
                        <?php endif; ?>
                        <?php if(isset($video['uploader'])): ?>
                            <video:uploader
                                info="<?php echo e($video['uploader']['info']); ?>"><?php echo e($video['uploader']['uploader']); ?></video:uploader>
                        <?php endif; ?>
                    </video:video>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
...
<?php /**PATH /home/oceanboats/public_html/platform/packages/sitemap/resources/views/xml.blade.php ENDPATH**/ ?>
...
<html lang="<?php echo e(app()->getLocale()); ?>">
 ...
 <!-- maryam -->
    ...
    <div class="section hero mob">
      <img class="w-100 h-100" src="<?php echo e(RvMedia::getImageUrl(isset($page) && isset($page->image) ? $page->image : 'bannerhome.jpg','400 x 400')); ?>" alt="Ocean Boats Banner Image">
      <div class="banner-text mob">
        <!-- <h1 class="heading1"><?php echo e((isset($page) && isset($page->name) ? $page->name : 'Accessories')); ?></h1> -->
        <h1 class="heading1"><?php echo $crumbs[$lastIndex]['label']; ?></h1>
            ...
            <div class="header-bar-container">
                ...
                <div class="header-thin">
                    <ul class="header-navbar-nav">
                        <li><a href="<?php echo e(url('contact')); ?>">Have any Questions?</a></li>
                        ...
                        <?php if(is_plugin_active('ecommerce')): ?>
                            <div class="search-style-2">
                                <form action="<?php echo e(route('public.products')); ?>" method="get">
                                    ...
                                    <input type="text" name="q" placeholder="<?php echo e(__('Search for items…')); ?>" autocomplete="off">
                            ...
                            <div class="header-action-right">
                                <div class="header-action-2">
                                    <?php if(EcommerceHelper::isCompareEnabled()): ?>
                                        <div class="header-action-icon-2">
                                            <a href="<?php echo e(route('public.compare')); ?>" class="compare-count">
                                                <img class="svgInject" alt="<?php echo e(__('Compare')); ?>" src="<?php echo e(Theme::asset()->url('images/icons/icon-compare.svg')); ?>">
                                                <span class="pro-count blue"><span><?php echo e(Cart::instance('compare')->count()); ?></span></span>
                                            </a>
                                        </div>
                                    <?php endif; ?>
                                    <?php if(EcommerceHelper::isWishlistEnabled()): ?>
                                        <div class="header-action-icon-2">
                                            <a href="<?php echo e(route('public.wishlist')); ?>" class="wishlist-count">
                                                <img class="svgInject" alt="<?php echo e(__('Wishlist')); ?>" src="<?php echo e(Theme::asset()->url('images/icons/icon-heart.svg')); ?>">
                                                <span class="pro-count blue"><?php if(auth('customer')->check()): ?><span><?php echo e(auth('customer')->user()->wishlist()->count()); ?></span> <?php else: ?> <span><?php echo e(Cart::instance('wishlist')->count()); ?></span><?php endif; ?></span>
                                            </a>
                                        </div>
                                    <?php endif; ?>
                                    <div class="header-action-icon-2">
                                        <a class="mini-cart-icon" href="<?php echo e(route('public.cart')); ?>">
                                            <img alt="<?php echo e(__('Cart')); ?>" src="<?php echo e(Theme::asset()->url('images/icons/icon-cart.svg')); ?>">
                                            <span class="pro-count blue"><?php echo e(Cart::instance('cart')->count()); ?></span>
                                        </a>
                                    ...
                                    <div class="header-action-icon-2">
                                        <a href="<?php echo e(route('customer.login')); ?>">
                                            <img alt="<?php echo e(__('Sign In')); ?>" src="<?php echo e(Theme::asset()->url('images/icons/icon-user.svg')); ?>">
                                        </a>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH /home/oceanboats/public_html/platform/themes/wowy/partials/header.blade.php ENDPATH**/ ?>
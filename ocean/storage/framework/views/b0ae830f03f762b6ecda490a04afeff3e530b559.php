<div class="flexbox-annotated-section">
    ...
    <div class="flexbox-annotated-section-content">
        <div class="wrapper-content pd-all-20">
            ...
            <?php if(config('plugins.analytics.general.ga4_enabled', false)): ?>
                <div class="form-group mb-3">
                    <label class="text-title-field"
                           for="analytics_property_id"><?php echo e(trans('plugins/analytics::analytics.settings.analytics_property_id')); ?></label>
                    <input data-counter="120" type="text" class="next-input" name="analytics_property_id" id="analytics_property_id"
                           value="<?php echo e(setting('analytics_property_id')); ?>" placeholder="<?php echo e(trans('plugins/analytics::analytics.settings.analytics_property_id_description')); ?>">
                </div>
            <?php else: ?>
                <div class="form-group mb-3">
                    <label class="text-title-field"
                    ...
                    <input data-counter="120" type="text" class="next-input" name="analytics_view_id" id="analytics_view_id"
                           value="<?php echo e(setting('analytics_view_id')); ?>" placeholder="<?php echo e(trans('plugins/analytics::analytics.settings.view_id_description')); ?>">
                </div>
            <?php endif; ?>
...
<?php /**PATH /home/oceanboats/public_html/platform/plugins/analytics/resources/views/setting.blade.php ENDPATH**/ ?>
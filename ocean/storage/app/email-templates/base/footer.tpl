            ...
            <tr>
                <td valign="top" style="border-collapse: collapse;">
                    <table width="800" align="center" border="0" cellspacing="0" cellpadding="0" class="full-width"
                           bgcolor="#182955" style="border-spacing: 0;">
                        <!--start space height -->
                        <tbody>
                        <tr>
                                                            ...
                                                            <tr>
                                                                <td align="left" valign="middle"
                                                                    ...
                                                                    <table width="760" border="0" align="left"
                                                                        ...
                                                                        <tr>
                                                                            <td style="font-size: 13px;line-height: 15px; text-align: center; font-family: Arial,Tahoma, Helvetica, sans-serif;color: #fff;font-weight: normal;border-collapse: collapse;">
                                                                                © Ocean Boats {{ date_year }}. All rights reserved.
                                                                            </td>
                                                                        </tr>
                                                                        </tbody>
                                                                    </table>
